...
# userlist和userdetail替换成一个viewsets
from rest_framework import viewsets
from rest_framework.decorators import action

#api_root由DefaultRouter自动创建
# @api_view(['GET'])
...
# SnippetList_generics，SnippetDetail_generics，SnippetHighlight合并成一个
...
class SnippetList_mixin(mixins.ListModelMixin,
...
# mixin
class SnippetDetail_mixin(mixins.RetrieveModelMixin,
